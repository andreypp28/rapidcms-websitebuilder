                    ...
                    <div class="feature-template-box old" data-index="{{ $ft->id }}" style="background:#efefef;">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Print Feature</th>
                                <th>Both Side</th>
                                <th class="text-right"><button type="button" class="btn btn-danger btn-remove-feature">Remove Feature</button></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr class="old" data-index="{{ $op->id }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <input type="button" class="btn btn-danger btn-remove-option" value="Remove"/>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
