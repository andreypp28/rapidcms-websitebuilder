            ...
            <div class="side-content">
                <ul class="nav-main">
                    ...
                    <li @if($menu == 'sales')class="open"@endif>
                        ...
                        <a @if($page == 'coupon')class="active"@endif href="{{ my_route('admin.sales.coupon.list') }}"><i class="glyphicon glyphicon-map-marker"></i><span class="sidebar-mini-hide">Coupons</span></a>
