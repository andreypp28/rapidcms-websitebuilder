                ...
                <div class="samp-exmpl-bl-table">
                    <div class="sampl-descr-wrap">
                        <div class="sampl-descr">
                            <p>This Premium Sample Pack including 15-20 sample business cards from luxury /high end to classic business card samples. Shipping is included for US and Canada. We ship with Canada Post and generally take 7-14 business days for delivery. We also offer Fedex Express shipping if you are located in other countries internationally or need speedy delivery and it has tracking number. Sample pack including {{ format_currency(10) }} coupon code for new customers. {{ format_currency(10) }} Coupon included in the sample pack. This sample pack does not include metal business cards. We change our sample cards from time to time, the exact samples photos you see on the website may not be included. If you are looking for a specific samples, please purchase our customized sample pack via email to <a href="mailto:{{ $settings['email.saler_email'] }}">{{ $settings['email.saler_email'] }}</a>.</p>
