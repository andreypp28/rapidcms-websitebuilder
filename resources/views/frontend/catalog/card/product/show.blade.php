            ...
            <div class="det-ord-bl">
                ...
                <div class="det-ord-cont">
                    ...
                    <div class="ord-sect-bl">
                        ...
                        <ul class="order-proc">
                            <li>1. Select the card quantity and print features. In order to get correct pricing, please make sure you have select all the features you wish to apply on the card.</li>
                            <li>2. If you are unsure about the features, please click on the "i" icon and it will bring you to the information page for that feature.</li>
                            ...
                            <li>5. Once the payment has completed, our designer will prepare a finalized print proof to your email.</li>
                            <li>6. After you have approved the proof, we will start the production. And will provide you a tracking number when its ready for shipping.</li>
                        </ul>
                    </div>
