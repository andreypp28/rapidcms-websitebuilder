<div class="templ-det-gallery" id="templ-det-gallery">
    ...
    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
        <a href="{{ resize_image( $img->image ) }}" itemprop="contentUrl" data-size="2500x1666">
            @if($i == 0)
            <img src="{{ resize_image( $img->image ) }}" alt="{{ $img->label }}" itemprop="thumbnail">
            @else
            <img src="{{ resize_image( $img->image, 510, 340, 'crop' ) }}" alt="{{ $img->label }}" itemprop="thumbnail">
            @endif
        </a>
