...
<div class="det-info-wrap">
    ...
    <div>
        For detail information on {{ $product->name }}, such as recommandation, design guideline, download blank template, please visit <a href="{{ $product->guide_link }}">{{ $product->name }} guideline.</a>
    </div>
</div>
...
<div class="det-info-wrap">
    ...
    <div>
        <p>If you need more than +10 sets of cards or need special custom printing, please visit <a href="#">Custom Quotation</a>page and get a free quotation.</p>
    </div>
</div>